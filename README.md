...
Fetch updates (`git fetch --tags`) and checkout newer release (`git checkout v2.4.0`). Run `bundle install` to install newly required gems. A database migration is not needed.
